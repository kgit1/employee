...
//annotated with @Bean producing beans manageable by spring container. In our 
//case, this class represent hibernate configuration.
//@ComponentScan is equivalent to context:component-scan base-package="..." 
//in xml, providing with where to look for spring managed beans/classes.
...
//@PropertySource is used to declare a set of properties(defined in a 
//properties file in application classpath) in Spring run-time Environment, 
...
//hibernate properties (same as hibernate.properties). Thanks to @PropertySource,
//we can externalize the real values in a .properties file, and use 
//Spring’s Environment to fetch the value corresponding to an item. 
